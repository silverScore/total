...
# Read csv file.
df = pd.read_csv("../silverScore/care/data/rankStatusData.csv", header=1)
...
df.to_sql(name='care_care', con=conn, if_exists='append', dtype=dtype, index=True, index_label="id")
conn.close()
